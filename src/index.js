...
if (todoList) {
  placeholderTodos.forEach((todo, index) => {
    ...
    todoItem.innerHTML = `
        <div class="checklist">
            <div class= "info">
                    <input class="checkbox" type="checkbox" id="todo-${
                      index + 1
                    }">
                    <label class="label priority ${todo.priority}" for="todo-${
      index + 1
    }">
                    ${todo.title}
                    </label>
...
prioritySelect.addEventListener("change", () => {
  ...
  prioritySelect.style.color =
    value === "low" ? "green" : value === "medium" ? "orange" : "red";
});
  ...
  todos.forEach((todo, index) => {
    ...
    todoItem.innerHTML = `
      <div class="checklist">
        <div class="info">
          <input class="checkbox" type="checkbox" id="${id}">
          <label class="label priority ${todo.priority}" for="${id}">${
      todo.title
    }</label>
          <div class="meta">
            ${
            ...
            ${
              todo.dueDate
                ? `<div class="due-date">Due: ${todo.dueDate}</div>`
                : ""
            }
          </div>
        </div>
